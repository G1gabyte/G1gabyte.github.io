...
if(isset($_GET['host'])&&isset($_GET['time'])){
  ...
  fclose($fp);
    ...
    echo "<br><b>By K3N1</b><br>Completed with $packets (" . round(($packets*65)/1024, 2) . " MB) packets averaging ". round($packets/$exec_time, 2) . " packets per second \n";
    echo '<br><br>
